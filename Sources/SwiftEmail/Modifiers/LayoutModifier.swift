...
extension ConditionalContent: LayoutableView
where TrueContent: LayoutableView, FalseContent: LayoutableView {
...
struct LayoutView<Content: View>: View {
  ...
  private func horizontalTD(width: Float?) -> AnyView {
    ...
    return AnyView(
      UnsafeNode(tag: "td", attributes: ["width": String(Int(width))]) {
        EmptyView()
      })
  }
}
