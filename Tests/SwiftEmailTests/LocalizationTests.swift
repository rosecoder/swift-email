...
struct LocalizationTests {
  ...
  @Test func textStaticKey() {
    do {
      let render = Text("testing", bundle: .module).environment(\.locale, Locale(identifier: "en"))
        .render()
      #expect(render.html == "Testing")
    }
    do {
      let render = Text("testing", bundle: .module).environment(\.locale, Locale(identifier: "sv"))
        .render()
  ...
  @Test func textFormattedKey() {
    do {
      let render = Text("testing \("hello")", bundle: .module).environment(
