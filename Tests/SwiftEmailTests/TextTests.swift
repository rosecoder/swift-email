...
struct TextTests {
  ...
  @Test func renderHTMLEscapeCharacters() {
    do {
      ...
      #expect(
        render.html == "&lt;script&gt;alert(&#39;XSS&#39;)&lt;/script&gt;"
      )
    }
    do {
    ...
    do {
      ...
      #expect(
        render.html == "&lt;img src=x onerror=alert(&#39;XSS&#39;)&gt;"
      )
    }
    do {
      let render = Text("<ScRiPt>alert('XSS')</ScRiPt>").render()
  ...
  @Test func fontBold() {
    ...
    #expect(
      render.html
        == "<b style=\"font-size:16px;font-weight:700;font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif\">Hello world!</b>"
    )
  }
  ...
  @Test func fontItalic() {
    ...
    #expect(
      render.html
        == "<i style=\"font-size:16px;font-weight:400;font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif;font-style:italic\">Hello world!</i>"
    )
  }
  ...
  @Test func fontBoldAndItalic() {
    ...
    #expect(
      render.html
        == "<i><b style=\"font-size:16px;font-weight:700;font-family:'Helvetica Neue', Helvetica, Arial, Verdana, sans-serif;font-style:italic\">Hello world!</b></i>"
    )
  }
